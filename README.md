...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td width="280" align="center" valign="middle" style="border: none; background: transparent;">
      <img src="./stark_reactor.svg?v=6" width="260" alt="Stark Reactor Core" style="border-radius: 12px; border: 2px solid #00f2fe; box-shadow: 0 0 20px rgba(0,242,254,0.4);" />
    </td>
    <td valign="top" style="border: none; background: transparent; padding-left: 20px;">
      <img src="./terminal_card.svg?v=6" alt="Terminal Card" width="100%" />
    </td>
  </tr>
</table>
...
<details open>
  <summary><b><kbd>./execute_threat_mitigation_protocol.sh</kbd></b></summary>
  <br>
  <img src="./stark_directive.svg?v=6" alt="Stark Mission Directive" width="100%" />
</details>
...
<details open>
  ...
  <a href="https://github.com/Rudra-Narayan-Pandey?tab=repositories">
    <img src="./projects_hud.svg?v=6" alt="Projects HUD Dashboard" width="100%" />
  </a>
</details>
...
<details open>
  ...
  <br>
  <img src="./commit_log.svg?v=6" alt="Scrolling Commit Log" width="100%" />
</details>
